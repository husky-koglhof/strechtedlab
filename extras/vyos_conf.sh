...
set service dhcp-server shared-network-name LAN subnet 192.168.16.0/24 static-mapping bootstrap mac c0:ff:ee:00:00:11
...
set service dns forwarding authoritative-domain openshift.${domain_name} records a control-plane-1 address 192.168.16.12
set service dns forwarding authoritative-domain openshift.${domain_name} records a control-plane-2 address 192.168.16.13
set service dns forwarding authoritative-domain openshift.${domain_name} records a control-plane-3 address 192.168.16.14

# PTR records for OpenShift control plane nodes
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 11 target bootstrap.openshift.${domain_name}

set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 12 target control-plane-1.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 13 target control-plane-2.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 14 target control-plane-3.openshift.${domain_name}

# A records for OpenShift compute nodes
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-1 address 192.168.16.15
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-2 address 192.168.16.16
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-3 address 192.168.16.17
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-4 address 192.168.16.18
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-5 address 192.168.16.19
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-6 address 192.168.16.20
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-7 address 192.168.16.21
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-8 address 192.168.16.22
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-9 address 192.168.16.23
set service dns forwarding authoritative-domain openshift.${domain_name} records a compute-10 address 192.168.16.24

# PTR records for OpenShift compute nodes
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 15 target compute-1.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 16 target compute-2.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 17 target compute-3.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 18 target compute-4.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 19 target compute-5.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 20 target compute-6.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 21 target compute-7.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 22 target compute-8.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 23 target compute-9.openshift.${domain_name}
set service dns forwarding authoritative-domain 16.168.192.in-addr.arpa records ptr 24 target compute-10.openshift.${domain_name}
